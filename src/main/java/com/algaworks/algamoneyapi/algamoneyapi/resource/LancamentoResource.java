...
import static com.algaworks.algamoneyapi.algamoneyapi.exceptionhandler.AlgaMoneyExceptionHandler.*;
...
public class LancamentoResource {
  ...
  public ResponseEntity<Object> handlePessoaInexistenteOuInativaException(PessoaInexistenteOuInativaException ex) {
    ...
    List<AlgaMoneyExceptionHandler.Erro> erros = Arrays.asList(new Erro(mensagemUsuario, mensagemDesenvolvedor));
